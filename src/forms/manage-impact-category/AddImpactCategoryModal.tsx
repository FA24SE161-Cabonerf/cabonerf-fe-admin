...
interface AddImpactCategoryModalProps {
  isOpen: boolean;
  onClose: () => void;
...
const AddImpactCategoryModal = ({ 
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto" aria-description="Add New Impact Category">
        <DialogHeader>
          ...
          <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
            ...
            <DialogFooter>
              <Button type="submit" disabled={isSubmitting} className="w-full sm:w-auto">
                {isSubmitting ? 'Adding...' : 'Add Impact Category'}
              </Button>
            </DialogFooter>
          </form>
        </Form>
...
export default AddImpactCategoryModal